...
3. Suppose you want to keep all your projects and practice Python programming in the directory `my_projects`. You need to create that directory. For that, execute the coomand `mkdir my_projects`, followed by executing the command `ls`. In the output, you should see the directory `my_projects` that you just created.
...
4. To exit the interactive mode, just execcute `exit()` from the interactive prompt.
